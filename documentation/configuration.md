...
| ITUKT_MANAGEMENT_CLAUSE_CACHE_CRON                             | Specifierer hvor ofte mellemlageret/cachen for klausuler opdateres i form af et CRON udtryk (0 0 0 * * *)                         | Ja       |
| ITUKT_VALIDATION_STAMDATA_CACHE_CRON                           | Specifierer hvor ofte mellemlageret/cachen for stamdata opdateres i form af et CRON udtryk (0 0 0 * * *)                          | Ja       |
| ITUKT_VALIDATION_SKIPPEDVALIDATION_CLEANUPJOB_CRON             | Specifierer hvor ofte oprydningsjobbet af tilsidesættelser skal køre i form af et CRON udtryk (0 0 0 * * *)                       | Ja       |
| ITUKT_VALIDATION_SKIPPEDVALIDATION_CLEANUPJOB_RETENTIONPERIOD  | Den tid (ISO 8601-varighed) tilsidesættelser bevares, før de slettes af oprydningsjobbet                                          | Ja       |
