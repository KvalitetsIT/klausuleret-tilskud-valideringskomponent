...
public class ManagementController implements ManagementApi {
    ...
    public ResponseEntity<DslOutput> management20250801ClausesDslIdGet(UUID id) {
        return service.readDsl(id)
                ...
                .orElseThrow(() -> new NotFoundApiException("Clause was not found"));
    }
    ...
    @Override
    public ResponseEntity<ClauseOutput> management20250801ClausesIdDelete(UUID id) {
        return ResponseEntity.ok(service.deleteDraft(id));
    }
    ...
    @Override
    public ResponseEntity<List<DslOutput>> management20250801ClausesDraftsNameHistoryGet(String name) {
        return ResponseEntity.ok(service.readDraftHistoryDsl(name));
    }
