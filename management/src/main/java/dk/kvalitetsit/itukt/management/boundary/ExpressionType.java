...
public class ExpressionType {
    public static final String INDICATION = "IndicationCondition";
    public static final String AGE = "AgeCondition";
    ...
    public static final String DEPARTMENT = "DepartmentCondition";
}
