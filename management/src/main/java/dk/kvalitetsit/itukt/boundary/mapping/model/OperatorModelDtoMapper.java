...
class OperatorModelDtoMapper implements Mapper< dk.kvalitetsit.itukt.model.Operator, Operator >  {
    @Override
    public Operator map(dk.kvalitetsit.itukt.model.Operator entry) {
        return switch (entry){
