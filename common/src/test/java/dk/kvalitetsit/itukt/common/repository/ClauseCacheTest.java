...
class ClauseCacheTest {
    ...
    void getClause_WhenClauseIsNotInCache_ReturnsEmptyOptional() {
        Clause existingClause = new Clause(1L, "test", null, null, null);
    ...
    void getClause_WhenClauseIsInCache_ReturnsClause() {
        Clause existingClause1 = new Clause(1L, "test1", null, null, null);
        Clause existingClause2 = new Clause(2L, "test2", null, null, null);
