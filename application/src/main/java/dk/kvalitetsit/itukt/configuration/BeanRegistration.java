...
public class BeanRegistration {
    ...
    @Bean
    public Mapper<org.openapitools.model.Clause, dk.kvalitetsit.itukt.common.model.Clause> dtoMapper() {
        return new DtoClauseMapper(new DtoExpressionMapper());
    }

    @Bean
    public Mapper<dk.kvalitetsit.itukt.common.model.Clause, org.openapitools.model.Clause> clauseDtoMapper() {
    ...
    @Bean
    public Mapper<dk.kvalitetsit.itukt.common.model.Clause, String> modelDslMapper() {
