...
public class ValidationIT extends BaseTest {
    ...
    private static void setupClauses() {
        ...
        var clauseInput = new ClauseEntityInput(CLAUSE_NAME, expression, CLAUSE_ERROR_MESSAGE, dk.kvalitetsit.itukt.common.model.Clause.Status.ACTIVE, "tester", null, null);
