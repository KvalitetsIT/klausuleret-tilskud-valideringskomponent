...
class ValidationServiceAdaptorTest {
    ...
    void validate_ValidatesWithMappedInput() {
        ...
        ValidationInput expectedValidationInput1 = new ValidationInput(
                ...
                new ValidationInput.Actor(creator1, Optional.empty()),
                Optional.of(new ValidationInput.Actor(reporter1, Optional.empty())),
        ...
        ValidationInput expectedValidationInput2 = new ValidationInput(
                request.getPersonIdentifier(),
                new ValidationInput.Actor(creator2, Optional.empty()),
                Optional.of(new ValidationInput.Actor(reporter2, Optional.empty())),
                request.getSkipValidations(),
                request.getAge(),
