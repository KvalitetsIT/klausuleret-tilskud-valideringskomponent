...
public class ExpressionTests {
    ...
    @Test
    void validate_errorShouldBeReturned10() {
        var expression = new CreatedByConditionExpression("speciale");
        var result = expression.validates(validationInput);
        assertEquals(empty(), result);
    }
    ...
    void validate_errorShouldBeReturned11() {
        var expression = new CreatedByConditionExpression("speciale-no-match");
        var result = expression.validates(validationInput);
        assertErrorMessage("speciale skal være speciale-no-match", result);
    }
