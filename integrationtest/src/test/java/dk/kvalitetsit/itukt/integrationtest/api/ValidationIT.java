...
public class ValidationIT extends BaseTest {
    ...
    void call20250801validatePost_WithInputThatMatchesClauseAndValidatesExistingDrugMedication_ReturnsSuccess() {
        ...
        var existingDrugMedication = new ExistingDrugMedicationOutput()
                .drugIdentifier(0L)
    ...
    private ValidationRequest createValidationRequest(String elementPath, int age, String indication, List<ExistingDrugMedicationOutput> existingDrugMedication) {
