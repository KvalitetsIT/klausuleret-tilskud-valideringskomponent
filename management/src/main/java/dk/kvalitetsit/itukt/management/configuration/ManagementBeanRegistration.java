...
public class ManagementBeanRegistration {
    ...
    public ExpressionValidator<Expression> expressionValidator(
            ...
            @Autowired DrugMedicationFormService drugMedicationFormService
    ) {
        var expressionValidatorFactory = new ExpressionValidatorFactory(departmentSpecialityService, drugMedicationFormService);
