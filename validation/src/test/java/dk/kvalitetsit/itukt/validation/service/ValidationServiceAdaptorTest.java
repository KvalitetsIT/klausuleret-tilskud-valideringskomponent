...
class ValidationServiceAdaptorTest {
    ...
    void validate_ValidatesWithMappedInput() {
        ...
        ValidationInput expectedValidationInput1 = new ValidationInput(request.getPersonIdentifier(), new ValidationInput.CreatedBy(creator1), Optional.of(reporter1), request.getSkipValidations(), request.getAge(), validate1.getNewDrugMedication().getDrugIdentifier(), validate1.getNewDrugMedication().getIndicationCode(), Optional.of(List.of(expectedExistingDrugMedication)));
        ValidationInput expectedValidationInput2 = new ValidationInput(request.getPersonIdentifier(), new ValidationInput.CreatedBy(creator2), Optional.of(reporter2), request.getSkipValidations(), request.getAge(), validate2.getNewDrugMedication().getDrugIdentifier(), validate2.getNewDrugMedication().getIndicationCode(), Optional.of(List.of(expectedExistingDrugMedication)));
