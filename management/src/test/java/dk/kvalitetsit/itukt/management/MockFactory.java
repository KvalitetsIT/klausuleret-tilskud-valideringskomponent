...
public class MockFactory {
    ...
    public static ClauseEntity CLAUSE_1_ENTITY = new ClauseEntity(1L, UUID.randomUUID(), "name", Clause.Status.ACTIVE, 10800, "message", EXPRESSION_1_ENTITY, "tester", new Date(), null);
    ...
    public static final ClauseOutput CLAUSE_1_OUTPUT = new ClauseOutput(CLAUSE_1_ENTITY.name(), EXPRESSION_1_DTO, CLAUSE_1_MODEL.error().message(), CLAUSE_1_MODEL.uuid(), mapStatus(CLAUSE_1_MODEL.status()), CLAUSE_1_MODEL.createdBy(), CLAUSE_1_MODEL.createdTime().toInstant().atOffset(ZoneOffset.UTC));
    ...
    private static ClauseStatus mapStatus(Clause.Status status) {
        return ClauseStatus.fromValue(status.name());
    }
}
