...
class OperatorModelDtoMapper implements Mapper< dk.kvalitetsit.klaus.model.Operator, Operator >  {
    @Override
    public Operator map(dk.kvalitetsit.klaus.model.Operator entry) {
        return switch (entry){
