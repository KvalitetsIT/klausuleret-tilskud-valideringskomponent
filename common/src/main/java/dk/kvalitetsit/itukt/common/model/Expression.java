...
public sealed interface Expression permits Expression.Condition, BinaryExpression {
    ...
    sealed interface ValidationFailed permits ValidationFailed.ValidationError, ValidationFailed.ExistingDrugMedicationRequired {
        record ExistingDrugMedicationRequired() implements ValidationFailed {}

        sealed interface ValidationError extends ValidationFailed permits AndError, HistoryError, UnsupportedError, OrError, SpecificError {
